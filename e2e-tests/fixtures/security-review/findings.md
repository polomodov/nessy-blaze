...
<blaze-security-finding title="Unvalidated File Upload Extensions" level="medium">
...
</blaze-security-finding>

<blaze-security-finding title="Missing CSRF Protection on State-Changing Operations" level="medium">
...
<blaze-security-finding title="SQL Injection in User Lookup" level="critical">
...
<blaze-security-finding title="Hardcoded AWS Credentials in Source Code" level="critical">
...
<blaze-security-finding title="Missing Authentication on Admin Endpoints" level="high">
...
<blaze-security-finding title="JWT Secret Using Default Value" level="high">
...
<blaze-security-finding title="Verbose Error Messages Expose Stack Traces" level="low">
...
<blaze-security-finding title="Missing Security Headers" level="low">
