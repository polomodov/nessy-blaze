...
test("edit code", async ({ po }) => {
  const editedFilePath = path.join("src", "components", "made-with-blaze.tsx");
  ...
  await po.page.getByText("made-with-blaze.tsx").click();
  await po.page
    .getByRole("code")
    .locator("div")
  ...
  await po.page
    ...
    .fill("export const MadeWithBlaze = ;");
  ...
  expect(editedFile).toContain("export const MadeWithBlaze = ;");
});
