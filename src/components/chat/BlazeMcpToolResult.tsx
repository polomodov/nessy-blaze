...
interface BlazeMcpToolResultProps {
  node?: any;
  children?: React.ReactNode;
}

export const BlazeMcpToolResult: React.FC<BlazeMcpToolResultProps> = ({
  node,
  children,
}) => {
  ...
  const prettyJson = useMemo(() => {
    ...
    try {
      ...
      console.error("Error parsing JSON for blaze-mcp-tool-result", e);
      return raw;
    }
  }, [expanded, raw]);
