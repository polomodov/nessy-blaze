...
interface BlazeProSuccessDialogProps {
  isOpen: boolean;
  onClose: () => void;
}

export function BlazeProSuccessDialog({
  isOpen,
  onClose,
}: BlazeProSuccessDialogProps) {
  return (
      ...
      <DialogContent className="max-w-md">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-3 text-xl">
            ...
            <span>Welcome to Blaze Pro!</span>
          </DialogTitle>
        </DialogHeader>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-start gap-3 p-3 rounded-lg bg-muted/50">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Blaze can work on bigger tasks and debug issues
                </p>
              </div>
            </div>
          </div>
