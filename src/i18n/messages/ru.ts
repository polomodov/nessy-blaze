...
export const ru = {
  ...
  "preview.tab.cloud": "Cloud",
  "preview.tab.design": "Дизайн",
  "preview.tab.code": "Код",
  "preview.tab.analytics": "Аналитика",
  "preview.tab.security": "Безопасность",
  "preview.tab.speed": "Скорость",
  "preview.tab.comingSoon": "Этот раздел скоро будет доступен.",
