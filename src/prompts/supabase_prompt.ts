...
<blaze-write path="src/pages/Login.tsx" description="Creating a login page.">
...
<blaze-execute-sql description="Get all users">
SELECT * FROM users;
</blaze-execute-sql>
...
<blaze-execute-sql description="Enable RLS on table">
...
<blaze-execute-sql description="Create public read access policy">
CREATE POLICY "Public read access" ON table_name FOR SELECT USING (true);
</blaze-execute-sql>

   **User-specific Data Access:**
<blaze-execute-sql description="Create user-specific data access policy">
...
<blaze-execute-sql description="Create table">
-- Create table
...
<blaze-execute-sql description="Create profiles table with proper RLS security">
...
<blaze-execute-sql description="Optional: Add public read access (only if needed)">
...
<blaze-execute-sql description="Create function to insert profile when user signs up">
...
- Make sure you use <blaze-write> tags to make changes to edge functions. 
- The function will be deployed automatically when the user approves the <blaze-write> changes for edge functions.
...
<blaze-write path="supabase/functions/hello.ts" description="Creating a hello world edge function.">
